...
@section('page-title')
    <title>Update Product Information | Ecommerce Portal</title>
@endsection
                                ...
                                <div class="col-lg-8">
                                    <div class="border border-3 p-4 rounded">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title" value="{{ $product->title }}" class="form-control" id="title" placeholder="Enter product title" autocomplete="off" autofocus required>
                                        </div>
                                            <div class="mb-3">
                                    ...
                                    <div class="border border-3 p-4 rounded">
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="regular_price" class="form-control" value="{{ $product->regular_price }}" id="regular_price" placeholder="00.00" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="offer_price" class="form-label">Offer Price [ BDT ]</label>
                                                <input type="text" name="offer_price" class="form-control" value="{{ $product->offer_price }}" id="offer_price" placeholder="00.00">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="quantity" class="form-label">Stock Quantity</label>
                                                <input type="text" name="quantity" class="form-control" value="{{ $product->quantity }}" id="quantity" placeholder="00.00" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label for="is_featured" class="form-label">Product Featured</label>
                                                ...
                                                <select class="form-select" name="category_id" id="category_id">
                                                    ...
                                                    @foreach ($pcategories as $pCat)
                                                        ...
                                                        @foreach (App\Models\Category::orderBy('name', 'asc')->where('is_parent', $pCat->id)->get() as $cCat )
                                                            <option value="{{ $cCat->id }}" @if( $cCat->id == $product->category_id ) selected @endif >-- {{ $cCat->name }}</option>
                                                        @endforeach
                                                    @endforeach
                                                </select>
                                            </div>
