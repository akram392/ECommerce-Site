...
@section('page-title')
    <title>Product Manage Trash | Ecommerce Portal</title>
@endsection
            ...
            <div class="card radius-10 w-100">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <div>
                            <h5 class="mb-0">View All Trash Products</h5>
                        </div>
                        <div class="dropdown options ms-auto">
                            <div>
                                <a href="{{ route('product.manage') }}" class="btn btn-primary btn-sm">View All Product</a>
                            </div>
                        </div>
                    </div>
                </div>
