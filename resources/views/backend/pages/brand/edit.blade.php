                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="Brand Name" value="{{ $brand->name }}" required autocomplete="off">
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" class="form-control" rows="3" placeholder="Write Description">{{ $brand->description }}</textarea>
                                </div>
                                <div class="mb-3">
