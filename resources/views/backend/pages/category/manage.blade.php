                ...
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown options ms-auto">
                            <div>
                                <a href="{{ route('category.trash') }}" class="btn btn-primary btn-sm">View Trash</a>
                            </div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ( !is_null($childCategory->image) )
                                                        <img src="{{ asset('images/category/' . $childCategory->image ) }}" alt="" width="35">
                                                    @else
                                                        N/A    
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    <div class="action-bar">
                                                        <ul>
                                                            <li>
                                                                <a href="{{ route('category.edit', $childCategory->id) }}">
                                                                    <i class="lni lni-pencil-alt"></i>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="" data-bs-toggle="modal" data-bs-target="#deleteCategory{{ $childCategory->id }}" >
                                                                    <i class="lni lni-trash"></i>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                ...
                                                <div class="modal fade" id="deleteCategory{{ $childCategory->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Are you confirm to delete this childCategory?</h5>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body text-center">
                                                                <div class="action-bar">
